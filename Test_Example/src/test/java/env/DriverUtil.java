...
public class DriverUtil {
	...
	public static WebDriver getDefaultDriver() {
		...
		switch(enviroment)
		{
			...
			case "desktop": DesiredCapabilities capabilities = new DesiredCapabilities();
    ...
    private static WebDriver chooseDriver(DesiredCapabilities capabilities) {
		...
		switch (preferredDriver.toLowerCase()) {
			...
			case "chrome":
				...
				System.setProperty("webdriver.chrome.driver",System.getProperty("driverPath","/Users/b0214198/Downloads/chromedriver_new3"));
				if (headless) {
    ...
    public static WebElement waitAndGetElementByCssSelector(WebDriver driver, String selector,
       ...
       return (new WebDriverWait(driver, seconds)).until(ExpectedConditions.visibilityOfElementLocated(selection));
    }
